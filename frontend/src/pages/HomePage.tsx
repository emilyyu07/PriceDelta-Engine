  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-800 rounded-lg p-8 text-white mb-8">
        <h1 className="text-4xl font-bold mb-4">Track Prices, Save Money</h1>
        <p className="text-xl mb-6">Get notified when prices drop on your favorite products</p>
        <Link
          to="/products"
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-primary-50 p-6 rounded-lg border border-primary-200 hover:shadow-lg transition">
          ...
          <p className="text-sm text-primary-600 mt-2">Products on sale today</p>
        </div>
        ...
        <div className="bg-primary-50 p-6 rounded-lg border border-primary-200 hover:shadow-lg transition">
          ...
          <p className="text-3xl font-bold text-primary-900">$247</p>
          <p className="text-sm text-primary-600 mt-2">Saved this month</p>
        </div>
      </div>
